...
func main() {
	...
	log.Printf("📋 Endpoints disponibles (algunos protegidos por JWT, admin o cliente):")
	log.Printf("   GET  /health (Público)")
	log.Printf("   POST /api/auth/registro (Público)")
	log.Printf("   POST /api/auth/login (Público)")
	log.Printf("   POST /api/auth/google (Público)")
	log.Printf("   GET  /api/auth/perfil (Protegido)")
	log.Printf("   GET  /api/auth/usuarios (Admin)")
	log.Printf("   DELETE /api/auth/usuarios/{id} (Admin)")
	log.Printf("   GET  /api/tipos-vidrio (Protegido)")
	log.Printf("   POST /api/cotizaciones (Protegido)")
	log.Printf("   GET  /api/cotizaciones (Protegido)")
	log.Printf("   GET, PUT, DELETE /api/cotizaciones/{id} (Protegido, PUT/DELETE Admin)")
	log.Printf("   PUT  /api/cotizaciones/{id}/asignar (Admin)")
	log.Printf("   POST /api/cotizaciones/preview (Protegido)")
	log.Printf("   GET  /api/mis-cotizaciones (Cliente)")
	log.Printf("   PUT  /api/cotizaciones/{id}/responder (Cliente)")
